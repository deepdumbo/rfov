...
class Radial:
    ...
    classdocs
    '''
    def __init__(self, Nx, NumBlade, result_angle, ClockWiseNess):
        '''
        Constructor
        '''
...
#         Ang = - Ang
        ...
        self.BLADES=numpy.empty((Nx,NumBlade),dtype=numpy.complex128)
...
if __name__ == '__main__':
    ...
    propObj=Radial( N ,  nblade,   theta,   -1)
    om = propObj.om
